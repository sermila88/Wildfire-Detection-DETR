...
#SBATCH --output=/vol/bitbucket/si324/rf-detr-wildfire/outputs/bounding_boxes/rfdetr_pred_bb-%j.out
#SBATCH --error=/vol/bitbucket/si324/rf-detr-wildfire/outputs/bounding_boxes/rfdetr_pred_bb-%j.err
