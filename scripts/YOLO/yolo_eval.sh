...
#SBATCH --output=outputs/yolo_baseline_v1/logs/eval-%j.out
#SBATCH --error=outputs/yolo_baseline_v1/logs/eval-%j.err
...
echo "📁 Results saved to: outputs/yolo_baseline_v1/eval_results/"
