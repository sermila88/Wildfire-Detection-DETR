#!/bin/bash
#SBATCH --job-name=RT-DETR_initial_training
#SBATCH --partition=gpgpu,AMD7-A100-T
#SBATCH --gres=gpu:1                  
#SBATCH --mem=32G                           
#SBATCH --mail-type=ALL               
#SBATCH --mail-user=si324           
#SBATCH --output=/vol/bitbucket/si324/rf-detr-wildfire/src/images/outputs/RT-DETR_initial_training/logs/%x-%j.out
#SBATCH --error=/vol/bitbucket/si324/rf-detr-wildfire/src/images/outputs/RT-DETR_initial_training/logs/%x-%j.err

echo "🔍 RT-DETR Initial Training"
...
mkdir -p src/images/outputs/RT-DETR_initial_training/logs
