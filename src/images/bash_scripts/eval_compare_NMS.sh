...
#SBATCH --error=/vol/bitbucket/si324/rf-detr-wildfire/src/images/eval_results_NMS/logs/eval_compare_NMS-%j.err
...
mkdir -p /vol/bitbucket/${USER}/rf-detr-wildfire/src/images/eval_results_NMS/logs

python src/images/eval/eval_compare_NMS.py
