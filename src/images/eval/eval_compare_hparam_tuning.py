"""
Evaluation script for YOLOv8, RF-DETR and RT-DETR after hyperparameter tuning
"""
...
# Configuration
OUTPUT_BASE_DIR = "/vol/bitbucket/si324/rf-detr-wildfire/src/images/compare_eval_results_hparam_tuning_w_best_hparams"
...
def create_comparison_visualizations(all_model_results, all_results_data, output_dir):
    ...
    model_order = ['YOLO_baseline', 'RT-DETR_hparam_tuning_NMS', 'RF-DETR_hparam_tuning_NMS']
    ...
    model_colors = {
        ...
        'RF-DETR_hparam_tuning_NMS': '#6A1B9A', 
        'RT-DETR_hparam_tuning_NMS': '#1565C0'
    }
...
if __name__ == "__main__":
    ...
    models = {
        ...
        "RF-DETR_hparam_tuning_NMS": {
            "type": "RF-DETR",
            "path": "/vol/bitbucket/si324/rf-detr-wildfire/src/images/outputs/RF-DETR_train_with_best_hparameters/checkpoints/checkpoint_best_ema.pth"
        },
        "RT-DETR_hparam_tuning_NMS": {
            "type": "RT-DETR",
